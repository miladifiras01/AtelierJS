...
but.addEventListener("click",
    () => {
        ...
        element.value = nom.value + ':' + content.value;
        left.appendChild(nvelt = document.createElement("div"));
        // nvelt.classList.add("row");
        ...
        nvelt.appendChild(element);
        nvelt.appendChild(ic);
        ic.addEventListener("click", () => {
            let i = ic.parentElement;
